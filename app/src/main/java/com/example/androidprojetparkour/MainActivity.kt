...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Router(viewModel)*/
            val viewModel = ViewModelProvider(this)[ObstacleViewModel::class.java]
            ...
            Column(modifier = Modifier.fillMaxSize().padding(25.dp)) {
                ListObstacles(viewModel, numObstacle) { nb -> setnbObstacles(nb) }
    ...
    fun ListObstacles(
        ...
        LaunchedEffect(Unit) {
            obstacleViewModel.getCourseObstacles(2795)
        }
        Column {
